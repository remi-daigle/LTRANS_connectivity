...
pld <- as.numeric(commandArgs(TRUE)[2])

print(paste("output distance_east.R year =",year,"pld =",pld))
...
gr2 <- read.graph('/sb/project/uxb-461-aa/Cuke-MPA/positions/distances/distance_graph.net', format="pajek")
